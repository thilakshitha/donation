...
public class UserAdapter3 extends RecyclerView.Adapter<UserAdapter3.UserViewHolder> {

    private Context context;
    private List<User> userList;

    public UserAdapter3(Context context, List<User> userList) {
    ...
    public UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_user_item3, parent, false);
